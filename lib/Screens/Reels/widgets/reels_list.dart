...
import 'package:snapflix/Screens/Reels/widgets/single_reel_video.dart';
...
class ReelsListView extends StatefulWidget {
  const ReelsListView({super.key, required this.post, required this.likes});
  final List likes;
  final PostModel post;

  @override
  State<ReelsListView> createState() => _ReelsListViewState();
}

class _ReelsListViewState extends State<ReelsListView> {
  @override
